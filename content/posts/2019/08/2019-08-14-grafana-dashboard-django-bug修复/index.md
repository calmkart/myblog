...
[https://grafana.com/grafana/dashboards/9528](https://grafana.com/grafana/dashboards/9528)

对应的django-metric是[https://github.com/korfuri/django-prometheus/](https://github.com/korfuri/django-prometheus/)

但是这个dashboard的页面是有问题的。页面的选择器选择的label是app，但是prometheus采集到的metric label是service和job。所以我们需要把dashboard json做一下修改。 <!--more-->
