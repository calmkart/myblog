...
根据输出 y\_hat 和人类认为的正确答案 y 做比对，通过梯度下降的偏微分方程计算，调整 F(x) 函数参数，最终使得 y\_hat 尽量接近 y 。
...
从哲学上来说，康德曾经为科学（即因果律/充足根据律）之所以可以成立，寻找过边界。康德将世界分为**物自体（实体）**和**表象（体验）**：

- **物自体**可以认识一切，却不能被一切所认识；
- **表象**是物自体在人类感知中的投影，是我们能够感知到的部分。
...
一方面，机器的输入来自人类对事物感知的表象，而这些表象一定符合属于人脑独有的因果律（即广义科学）。另一方面，通过梯度下降训练的标准输出 y 会让 y\_hat 也尽量接近人脑独有的因果律（科学结果）。因此，机器永远无法超越人类认识物自体的表象（人脑的认识）。
