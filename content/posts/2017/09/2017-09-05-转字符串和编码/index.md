...
![char-encoding-problem](images/0)
...
![set-encoding-in-notepad++](images/001427719248811c5f9fd37acf54f6f93d7affbd80dd79b000)

如果`.py`文件本身使用UTF-8编码，并且也申明了`# -*- coding: utf-8 -*-`，打开命令提示符测试就可以正常显示中文：

![py-chinese-test-in-cmd](images/0014277193240041efdda5a5de14f58a0879d8d4efcee66000)
