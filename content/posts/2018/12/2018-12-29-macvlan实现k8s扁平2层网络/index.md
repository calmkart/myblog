...
最终结果 nodes [![](images/nodes.jpg)](http://www.calmkart.com/wp-content/uploads/2018/12/nodes.jpg) pods [![](images/pods.jpg)](http://www.calmkart.com/wp-content/uploads/2018/12/pods.jpg)

测试某一个pod [![](images/some_pod.png)](http://www.calmkart.com/wp-content/uploads/2018/12/some_pod.png)

本机直接ip访问pod [![](images/nginx_pod.jpg)](http://www.calmkart.com/wp-content/uploads/2018/12/nginx_pod.jpg)
...
> **huanguo** (2019-01-10 20:22)
>
> 给大佬点赞

> **( 曰..曰 )** (2019-01-22 21:01)
>
> 大佬，psc还缺保安吗？
...
> **wardenlym** (2019-03-14 14:36)
>
> 帮大忙了.jpg

> **wardenlym** (2019-03-14 15:34)
>
> kubeadm init 时候不需要加任何参数吗？它是怎么能识别出来用的是macvlan的呢
> 请教

  > ↳ **calmkart** (2019-03-14 19:22)
  >
  > k8s的网络插件需要配置啊,要写配置文件.k8s会自己读.而且随时可以换的.

  > ↳ **WEICHANG** (2019-08-06 16:47)
  >
  > 请问下，这个流程你那边能跑通吗？

> **bro** (2019-03-15 10:40)
>
> 请问下k8s网络插件可以热配置么，在不停服的情况下？

  > ↳ **calmkart** (2019-03-17 21:33)
  >
  > 可以

> **carmer** (2019-04-01 19:22)
>
> 老哥哥，你有github地址么，让小弟star下啊

  > ↳ **calmkart** (2019-04-01 19:30)
  >
  > https://github.com/calmkart
  > 欢迎关注，欢迎star

> **WEICHANG** (2019-08-06 17:50)
>
> 博主，我这边init初始化集群的时候，coredns节点起不来：0/1 nodes are available: 1 node(s) had taints that the pod didn't tolerate. reset了很多次都是这样。。。请问下有什么特别需要注意的地方吗。。。搞了两天了，绝望.jpg

> **calmkart** (2019-08-09 15:25)
>
> 你master节点有taints但是pods选择器没有tolerate导致调度器找不到可以调度的节点.
> 试着把master节点的污点去掉试试呢
> kubectl taint nodes --all node-role.kubernetes.io/master-
